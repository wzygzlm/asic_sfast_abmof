...
reg   [0:0] tmp_V_reg_331;
reg    ap_predicate_op33_write_state2;
reg    ap_block_state2_io;
reg    ap_block_state3_pp0_stage0_iter2;
reg   [0:0] tmp_174_reg_341_pp0_iter1_reg;
reg   [0:0] tmp_V_reg_331_pp0_iter1_reg;
...
reg   [15:0] y_V_reg_310;
wire   [15:0] x_V_fu_178_p1;
reg   [15:0] x_V_reg_315;
reg   [0:0] pol_V_reg_320;
reg   [62:0] p_Result_i_reg_326;
wire   [0:0] tmp_V_read_fu_118_p2;
wire   [7:0] retData_V_fu_216_p3;
reg   [7:0] retData_V_reg_335;
wire   [63:0] tmp_49_i_fu_236_p2;
wire   [63:0] p_Result_s_fu_254_p5;
wire   [7:0] tmp_V_36_cast_fu_266_p1;
wire   [15:0] tmp_V_40_cast_fu_270_p1;
wire   [7:0] tmp_V_45_cast_fu_274_p1;
wire   [15:0] tmp_V_47_cast_fu_278_p1;
reg    ap_block_pp0_stage0_subdone;
wire   [63:0] ap_phi_reg_pp0_iter0_cornerEventsNum_loc_s_reg_159;
reg   [63:0] ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_159;
wire   [63:0] tmp_50_i_fu_292_p2;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] tmp_fu_200_p1;
wire   [7:0] tmp_i_fu_204_p3;
wire   [7:0] tmp_48_cast_i_fu_212_p1;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_150)) begin
        if ((tmp_V_read_fu_118_p2 == 1'd0)) begin
            ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_159 <= cornerEventsNum;
        end else if ((tmp_V_read_fu_118_p2 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_159 <= tmp_49_i_fu_236_p2;
        end else if ((1'b1 == 1'b1)) begin
            ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_159 <= ap_phi_reg_pp0_iter0_cornerEventsNum_loc_s_reg_159;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_V_read_fu_118_p2 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        cornerEventsNum <= tmp_49_i_fu_236_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        outEventsNum <= tmp_50_i_fu_292_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_Result_i_reg_326 <= {{packetEventDataStrea_dout[95:33]}};
        pol_V_reg_320 <= packetEventDataStrea_dout[32'd32];
        retData_V_reg_335[1 : 0] <= retData_V_fu_216_p3[1 : 0];
retData_V_reg_335[3] <= retData_V_fu_216_p3[3];
retData_V_reg_335[5] <= retData_V_fu_216_p3[5];
retData_V_reg_335[7] <= retData_V_fu_216_p3[7];
        tmp_174_reg_341 <= p_read[32'd1];
        tmp_174_reg_341_pp0_iter1_reg <= tmp_174_reg_341;
        tmp_V_reg_331 <= stageCornerStream_V_s_dout;
        tmp_V_reg_331_pp0_iter1_reg <= tmp_V_reg_331;
        x_V_reg_315 <= x_V_fu_178_p1;
        y_V_reg_310 <= {{packetEventDataStrea_dout[31:16]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((tsStreamOut_V_V_1_load_A == 1'b1)) begin
        tsStreamOut_V_V_1_payload_A <= p_Result_s_fu_254_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((tsStreamOut_V_V_1_load_B == 1'b1)) begin
        tsStreamOut_V_V_1_payload_B <= p_Result_s_fu_254_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((xStreamOut_V_V_1_load_A == 1'b1)) begin
        xStreamOut_V_V_1_payload_A <= x_V_reg_315;
    end
end

always @ (posedge ap_clk) begin
    if ((xStreamOut_V_V_1_load_B == 1'b1)) begin
        xStreamOut_V_V_1_payload_B <= x_V_reg_315;
    end
end

always @ (posedge ap_clk) begin
    if ((yStreamOut_V_V_1_load_A == 1'b1)) begin
        yStreamOut_V_V_1_payload_A <= y_V_reg_310;
    end
end

always @ (posedge ap_clk) begin
    if ((yStreamOut_V_V_1_load_B == 1'b1)) begin
        yStreamOut_V_V_1_payload_B <= y_V_reg_310;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((ap_predicate_op33_write_state2 == 1'b1)) begin
            custDataStreamOut_V_s_1_data_in = tmp_V_47_cast_fu_278_p1;
        end else if ((tmp_174_reg_341 == 1'd0)) begin
            custDataStreamOut_V_s_1_data_in = tmp_V_40_cast_fu_270_p1;
        end else begin
...
always @ (*) begin
    if ((((ap_predicate_op33_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_174_reg_341 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    if ((((ap_predicate_op57_write_state3 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_predicate_op33_write_state2 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_174_reg_341 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((ap_predicate_op33_write_state2 == 1'b1)) begin
            polStreamOut_V_V_1_data_in = tmp_V_45_cast_fu_274_p1;
        end else if ((tmp_174_reg_341 == 1'd0)) begin
            polStreamOut_V_V_1_data_in = tmp_V_36_cast_fu_266_p1;
        end else begin
...
always @ (*) begin
    ap_block_state2_io = (((ap_predicate_op33_write_state2 == 1'b1) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((ap_predicate_op33_write_state2 == 1'b1) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op33_write_state2 == 1'b1) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op33_write_state2 == 1'b1) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341 == 1'd0) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((tmp_174_reg_341 == 1'd0) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341 == 1'd0) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341 == 1'd0) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op33_write_state2 == 1'b1) & (xStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341 == 1'd0) & (xStreamOut_V_V_1_ack_in == 1'b0)));
end

assign ap_block_state2_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_io = (((ap_predicate_op57_write_state3 == 1'b1) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (custDataStreamOut_V_s_1_ack_in == 1'b0)) | ((ap_predicate_op57_write_state3 == 1'b1) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (tsStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op57_write_state3 == 1'b1) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (polStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op57_write_state3 == 1'b1) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (yStreamOut_V_V_1_ack_in == 1'b0)) | ((ap_predicate_op57_write_state3 == 1'b1) & (xStreamOut_V_V_1_ack_in == 1'b0)) | ((tmp_174_reg_341_pp0_iter1_reg == 1'd0) & (xStreamOut_V_V_1_ack_in == 1'b0)));
end
...
assign ap_phi_reg_pp0_iter0_cornerEventsNum_loc_s_reg_159 = 'bx;

always @ (*) begin
    ap_predicate_op33_write_state2 = ((tmp_V_reg_331 == 1'd1) & (tmp_174_reg_341 == 1'd1));
end

always @ (*) begin
    ap_predicate_op57_write_state3 = ((tmp_V_reg_331_pp0_iter1_reg == 1'd1) & (tmp_174_reg_341_pp0_iter1_reg == 1'd1));
end
...
assign glStatus_cornerEvent = ap_phi_reg_pp0_iter1_cornerEventsNum_loc_s_reg_159;

assign glStatus_currentThre = p_read1;

assign glStatus_outEventsNu = (outEventsNum + 64'd2);

assign p_Result_s_fu_254_p5 = {{ap_const_lv64_0[63:63]}, {p_Result_i_reg_326}};
...
assign retData_V_fu_216_p3 = ((tmp_fu_200_p1[0:0] === 1'b1) ? tmp_i_fu_204_p3 : tmp_48_cast_i_fu_212_p1);

assign tmp_48_cast_i_fu_212_p1 = stageCornerStream_V_s_dout;

assign tmp_49_i_fu_236_p2 = (cornerEventsNum + 64'd1);

assign tmp_50_i_fu_292_p2 = (outEventsNum + 64'd2);

assign tmp_V_36_cast_fu_266_p1 = pol_V_reg_320;

assign tmp_V_40_cast_fu_270_p1 = retData_V_reg_335;

assign tmp_V_45_cast_fu_274_p1 = pol_V_reg_320;

assign tmp_V_47_cast_fu_278_p1 = retData_V_reg_335;

assign tmp_V_read_fu_118_p2 = stageCornerStream_V_s_dout;

assign tmp_fu_200_p1 = p_read[0:0];

assign tmp_i_fu_204_p3 = ((stageCornerStream_V_s_dout[0:0] === 1'b1) ? 8'd170 : 8'd0);
...
assign x_V_fu_178_p1 = packetEventDataStrea_dout[15:0];
...
always @ (posedge ap_clk) begin
    retData_V_reg_335[2] <= 1'b0;
    retData_V_reg_335[4:4] <= 1'b0;
    retData_V_reg_335[6] <= 1'b0;
end
