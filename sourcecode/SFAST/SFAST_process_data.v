...
reg    ap_rst_n_inv;
wire    SFAST_process_data_e_1_U0_ap_start;
wire    SFAST_process_data_e_1_U0_ap_done;
wire    SFAST_process_data_e_1_U0_ap_continue;
wire    SFAST_process_data_e_1_U0_ap_idle;
wire    SFAST_process_data_e_1_U0_ap_ready;
wire    SFAST_process_data_e_1_U0_start_out;
wire    SFAST_process_data_e_1_U0_start_write;
wire   [31:0] SFAST_process_data_e_1_U0_config_V_out_din;
wire    SFAST_process_data_e_1_U0_config_V_out_write;
wire    SFAST_process_data_e_1_1_U0_ap_start;
wire    SFAST_process_data_e_1_1_U0_ap_done;
wire    SFAST_process_data_e_1_1_U0_ap_continue;
wire    SFAST_process_data_e_1_1_U0_ap_idle;
wire    SFAST_process_data_e_1_1_U0_ap_ready;
wire    SFAST_process_data_e_1_1_U0_start_out;
wire    SFAST_process_data_e_1_1_U0_start_write;
wire    SFAST_process_data_e_1_1_U0_config_V_read;
wire   [31:0] SFAST_process_data_e_1_1_U0_config_V_out_din;
...
wire    Block_proc124_U0_ap_start;
wire    Block_proc124_U0_ap_done;
wire    Block_proc124_U0_ap_continue;
wire    Block_proc124_U0_ap_idle;
wire    Block_proc124_U0_ap_ready;
wire    Block_proc124_U0_pktEventDataStream_V_V_read;
wire    Block_proc124_U0_stageCornerStream_V_V_read;
wire   [15:0] Block_proc124_U0_xStreamOut_V_V_TDATA;
wire    Block_proc124_U0_xStreamOut_V_V_TVALID;
wire   [15:0] Block_proc124_U0_yStreamOut_V_V_TDATA;
wire    Block_proc124_U0_yStreamOut_V_V_TVALID;
wire   [7:0] Block_proc124_U0_polStreamOut_V_V_TDATA;
wire    Block_proc124_U0_polStreamOut_V_V_TVALID;
wire   [63:0] Block_proc124_U0_tsStreamOut_V_V_TDATA;
wire    Block_proc124_U0_tsStreamOut_V_V_TVALID;
wire   [15:0] Block_proc124_U0_isFinalCornerStream_V_V_TDATA;
wire    Block_proc124_U0_isFinalCornerStream_V_V_TVALID;
wire   [63:0] Block_proc124_U0_status_inEventsNum;
wire    Block_proc124_U0_status_inEventsNum_ap_vld;
wire   [63:0] Block_proc124_U0_status_outEventsNum;
wire    Block_proc124_U0_status_outEventsNum_ap_vld;
wire   [63:0] Block_proc124_U0_status_cornerEventsNum;
wire    Block_proc124_U0_status_cornerEventsNum_ap_vld;
wire   [31:0] Block_proc124_U0_status_currentThreshold;
wire    Block_proc124_U0_status_currentThreshold_ap_vld;
wire    Block_proc124_U0_glConfig_V_read;
wire    Block_proc124_U0_glSFASTThrBak_read;
...
wire    glConfig_V_c8_full_n;
wire   [31:0] glConfig_V_c8_dout;
wire    glConfig_V_c8_empty_n;
...
reg    ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready;
wire    ap_sync_SFAST_process_data_e_1_U0_ap_ready;
reg   [1:0] SFAST_process_data_e_1_U0_ap_ready_count;
wire   [0:0] start_for_SFAST_process_data_e_1_1_U0_din;
wire    start_for_SFAST_process_data_e_1_1_U0_full_n;
wire   [0:0] start_for_SFAST_process_data_e_1_1_U0_dout;
wire    start_for_SFAST_process_data_e_1_1_U0_empty_n;
...
wire   [0:0] start_for_Block_proc124_U0_din;
wire    start_for_Block_proc124_U0_full_n;
wire   [0:0] start_for_Block_proc124_U0_dout;
...
wire    Block_proc124_U0_start_full_n;
wire    Block_proc124_U0_start_write;
...
#0 ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready = 1'b0;
#0 SFAST_process_data_e_1_U0_ap_ready_count = 2'd0;
end

SFAST_process_data_e_1 SFAST_process_data_e_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(SFAST_process_data_e_1_U0_ap_start),
    .start_full_n(start_for_SFAST_process_data_e_1_1_U0_full_n),
    .ap_done(SFAST_process_data_e_1_U0_ap_done),
    .ap_continue(SFAST_process_data_e_1_U0_ap_continue),
    .ap_idle(SFAST_process_data_e_1_U0_ap_idle),
    .ap_ready(SFAST_process_data_e_1_U0_ap_ready),
    .start_out(SFAST_process_data_e_1_U0_start_out),
    .start_write(SFAST_process_data_e_1_U0_start_write),
    .config_V(config_V),
    .config_V_out_din(SFAST_process_data_e_1_U0_config_V_out_din),
    .config_V_out_full_n(config_V_c1_full_n),
    .config_V_out_write(SFAST_process_data_e_1_U0_config_V_out_write)
);

SFAST_process_data_e_1_1 SFAST_process_data_e_1_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(SFAST_process_data_e_1_1_U0_ap_start),
    .start_full_n(start_for_Block_proc_U0_full_n),
    .ap_done(SFAST_process_data_e_1_1_U0_ap_done),
    .ap_continue(SFAST_process_data_e_1_1_U0_ap_continue),
    .ap_idle(SFAST_process_data_e_1_1_U0_ap_idle),
    .ap_ready(SFAST_process_data_e_1_1_U0_ap_ready),
    .start_out(SFAST_process_data_e_1_1_U0_start_out),
    .start_write(SFAST_process_data_e_1_1_U0_start_write),
    .config_V_dout(config_V_c1_dout),
    .config_V_empty_n(config_V_c1_empty_n),
    .config_V_read(SFAST_process_data_e_1_1_U0_config_V_read),
    .config_V_out_din(SFAST_process_data_e_1_1_U0_config_V_out_din),
    .config_V_out_full_n(config_V_c_full_n),
    .config_V_out_write(SFAST_process_data_e_1_1_U0_config_V_out_write)
);

SFAST_Block_proc SFAST_Block_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
checkIdxGeneralV3_4_s checkIdxGeneralV3_4_U0(
    ...
    .glConfig_V_out_full_n(glConfig_V_c8_full_n),
...
Block_proc124 Block_proc124_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(Block_proc124_U0_ap_start),
    .ap_done(Block_proc124_U0_ap_done),
    .ap_continue(Block_proc124_U0_ap_continue),
    .ap_idle(Block_proc124_U0_ap_idle),
    .ap_ready(Block_proc124_U0_ap_ready),
    .pktEventDataStream_V_V_dout(pktEventDataStream_V_dout),
    .pktEventDataStream_V_V_empty_n(pktEventDataStream_V_empty_n),
    .pktEventDataStream_V_V_read(Block_proc124_U0_pktEventDataStream_V_V_read),
    .stageCornerStream_V_V_dout(stageCornerStream_V_s_dout),
    .stageCornerStream_V_V_empty_n(stageCornerStream_V_s_empty_n),
    .stageCornerStream_V_V_read(Block_proc124_U0_stageCornerStream_V_V_read),
    .xStreamOut_V_V_TDATA(Block_proc124_U0_xStreamOut_V_V_TDATA),
    .xStreamOut_V_V_TVALID(Block_proc124_U0_xStreamOut_V_V_TVALID),
    .xStreamOut_V_V_TREADY(xStreamOut_V_V_TREADY),
    .yStreamOut_V_V_TDATA(Block_proc124_U0_yStreamOut_V_V_TDATA),
    .yStreamOut_V_V_TVALID(Block_proc124_U0_yStreamOut_V_V_TVALID),
    .yStreamOut_V_V_TREADY(yStreamOut_V_V_TREADY),
    .polStreamOut_V_V_TDATA(Block_proc124_U0_polStreamOut_V_V_TDATA),
    .polStreamOut_V_V_TVALID(Block_proc124_U0_polStreamOut_V_V_TVALID),
    .polStreamOut_V_V_TREADY(polStreamOut_V_V_TREADY),
    .tsStreamOut_V_V_TDATA(Block_proc124_U0_tsStreamOut_V_V_TDATA),
    .tsStreamOut_V_V_TVALID(Block_proc124_U0_tsStreamOut_V_V_TVALID),
    .tsStreamOut_V_V_TREADY(tsStreamOut_V_V_TREADY),
    .isFinalCornerStream_V_V_TDATA(Block_proc124_U0_isFinalCornerStream_V_V_TDATA),
    .isFinalCornerStream_V_V_TVALID(Block_proc124_U0_isFinalCornerStream_V_V_TVALID),
    .isFinalCornerStream_V_V_TREADY(isFinalCornerStream_V_V_TREADY),
    .status_inEventsNum(Block_proc124_U0_status_inEventsNum),
    .status_inEventsNum_ap_vld(Block_proc124_U0_status_inEventsNum_ap_vld),
    .status_outEventsNum(Block_proc124_U0_status_outEventsNum),
    .status_outEventsNum_ap_vld(Block_proc124_U0_status_outEventsNum_ap_vld),
    .status_cornerEventsNum(Block_proc124_U0_status_cornerEventsNum),
    .status_cornerEventsNum_ap_vld(Block_proc124_U0_status_cornerEventsNum_ap_vld),
    .status_currentThreshold(Block_proc124_U0_status_currentThreshold),
    .status_currentThreshold_ap_vld(Block_proc124_U0_status_currentThreshold_ap_vld),
    .glConfig_V_dout(glConfig_V_c8_dout),
    .glConfig_V_empty_n(glConfig_V_c8_empty_n),
    .glConfig_V_read(Block_proc124_U0_glConfig_V_read),
    .glSFASTThrBak_dout(glSFASTThrBak_c_dout),
    .glSFASTThrBak_empty_n(glSFASTThrBak_c_empty_n),
    .glSFASTThrBak_read(Block_proc124_U0_glSFASTThrBak_read),
    .glStatus_inEventsNum_dout(glStatus_inEventsNum_dout),
    .glStatus_inEventsNum_empty_n(glStatus_inEventsNum_empty_n),
    .glStatus_inEventsNum_read(Block_proc124_U0_glStatus_inEventsNum_read)
);
...
fifo_w32_d2_A config_V_c1_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SFAST_process_data_e_1_U0_config_V_out_din),
    .if_full_n(config_V_c1_full_n),
    .if_write(SFAST_process_data_e_1_U0_config_V_out_write),
    .if_dout(config_V_c1_dout),
    .if_empty_n(config_V_c1_empty_n),
    .if_read(SFAST_process_data_e_1_1_U0_config_V_read)
);
...
fifo_w32_d2_A config_V_c_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(SFAST_process_data_e_1_1_U0_config_V_out_din),
    .if_full_n(config_V_c_full_n),
    .if_write(SFAST_process_data_e_1_1_U0_config_V_out_write),
    .if_dout(config_V_c_dout),
    .if_empty_n(config_V_c_empty_n),
    .if_read(Block_proc_U0_config_V_read)
);

fifo_w32_d4_A glConfig_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w96_d10_S pktEventDataStream_V_U(
    ...
    .if_read(Block_proc124_U0_pktEventDataStream_V_V_read)
);
...
fifo_w64_d7_A glStatus_inEventsNum_U(
    ...
    .if_read(Block_proc124_U0_glStatus_inEventsNum_read)
);
...
fifo_w32_d4_A glConfig_V_c8_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(checkIdxGeneralV3_4_U0_glConfig_V_out_din),
    .if_full_n(glConfig_V_c8_full_n),
    .if_write(checkIdxGeneralV3_4_U0_glConfig_V_out_write),
    .if_dout(glConfig_V_c8_dout),
    .if_empty_n(glConfig_V_c8_empty_n),
    .if_read(Block_proc124_U0_glConfig_V_read)
);
...
fifo_w8_d4_A glSFASTThrBak_c_U(
    ...
    .if_read(Block_proc124_U0_glSFASTThrBak_read)
);
...
fifo_w1_d2_A stageCornerStream_V_s_U(
    ...
    .if_read(Block_proc124_U0_stageCornerStream_V_V_read)
);

start_for_SFAST_pNgs start_for_SFAST_pNgs_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_SFAST_process_data_e_1_1_U0_din),
    .if_full_n(start_for_SFAST_process_data_e_1_1_U0_full_n),
    .if_write(SFAST_process_data_e_1_U0_start_write),
    .if_dout(start_for_SFAST_process_data_e_1_1_U0_dout),
    .if_empty_n(start_for_SFAST_process_data_e_1_1_U0_empty_n),
    .if_read(SFAST_process_data_e_1_1_U0_ap_ready)
);
...
start_for_Block_pQgW start_for_Block_pQgW_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_Block_proc124_U0_din),
    .if_full_n(start_for_Block_proc124_U0_full_n),
    .if_write(preProcessStream_U0_start_write),
    .if_dout(start_for_Block_proc124_U0_dout),
    .if_empty_n(start_for_Block_proc124_U0_empty_n),
    .if_read(Block_proc124_U0_ap_ready)
);

always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready <= 1'b0;
        end else begin
            ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready <= ap_sync_SFAST_process_data_e_1_U0_ap_ready;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (1'b0 == SFAST_process_data_e_1_U0_ap_ready))) begin
        SFAST_process_data_e_1_U0_ap_ready_count <= (SFAST_process_data_e_1_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == SFAST_process_data_e_1_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        SFAST_process_data_e_1_U0_ap_ready_count <= (SFAST_process_data_e_1_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_proc124_U0_ap_continue = 1'b1;

assign Block_proc124_U0_ap_start = start_for_Block_proc124_U0_empty_n;

assign Block_proc124_U0_start_full_n = 1'b1;

assign Block_proc124_U0_start_write = 1'b0;
...
assign SFAST_process_data_e_1_1_U0_ap_continue = 1'b1;

assign SFAST_process_data_e_1_1_U0_ap_start = start_for_SFAST_process_data_e_1_1_U0_empty_n;

assign SFAST_process_data_e_1_U0_ap_continue = 1'b1;

assign SFAST_process_data_e_1_U0_ap_start = ((ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready ^ 1'b1) & ap_start);
...
assign ap_sync_SFAST_process_data_e_1_U0_ap_ready = (ap_sync_reg_SFAST_process_data_e_1_U0_ap_ready | SFAST_process_data_e_1_U0_ap_ready);
...
assign ap_sync_done = Block_proc124_U0_ap_done;

assign ap_sync_preProcessStream_U0_ap_ready = (preProcessStream_U0_ap_ready | ap_sync_reg_preProcessStream_U0_ap_ready);

assign ap_sync_ready = (ap_sync_preProcessStream_U0_ap_ready & ap_sync_SFAST_process_data_e_1_U0_ap_ready);
...
assign isFinalCornerStream_V_V_TDATA = Block_proc124_U0_isFinalCornerStream_V_V_TDATA;

assign isFinalCornerStream_V_V_TVALID = Block_proc124_U0_isFinalCornerStream_V_V_TVALID;

assign polStreamIn_V_V_TREADY = preProcessStream_U0_polStreamIn_V_V_TREADY;

assign polStreamOut_V_V_TDATA = Block_proc124_U0_polStreamOut_V_V_TDATA;

assign polStreamOut_V_V_TVALID = Block_proc124_U0_polStreamOut_V_V_TVALID;
...
assign preProcessStream_U0_start_full_n = (start_for_rwSAEPerfectLoopStre_U0_full_n & start_for_Block_proc124_U0_full_n);
...
assign start_for_Block_proc124_U0_din = 1'b1;

assign start_for_Block_proc_U0_din = 1'b1;

assign start_for_SFAST_process_data_e_1_1_U0_din = 1'b1;

assign start_for_rwSAEPerfectLoopStre_U0_din = 1'b1;

assign status_cornerEventsNum = Block_proc124_U0_status_cornerEventsNum;

assign status_cornerEventsNum_ap_vld = Block_proc124_U0_status_cornerEventsNum_ap_vld;

assign status_currentThreshold = Block_proc124_U0_status_currentThreshold;

assign status_currentThreshold_ap_vld = Block_proc124_U0_status_currentThreshold_ap_vld;

assign status_inEventsNum = Block_proc124_U0_status_inEventsNum;

assign status_inEventsNum_ap_vld = Block_proc124_U0_status_inEventsNum_ap_vld;

assign status_outEventsNum = Block_proc124_U0_status_outEventsNum;

assign status_outEventsNum_ap_vld = Block_proc124_U0_status_outEventsNum_ap_vld;

assign tsStreamIn_V_V_TREADY = preProcessStream_U0_tsStreamIn_V_V_TREADY;

assign tsStreamOut_V_V_TDATA = Block_proc124_U0_tsStreamOut_V_V_TDATA;

assign tsStreamOut_V_V_TVALID = Block_proc124_U0_tsStreamOut_V_V_TVALID;

assign xStreamIn_V_V_TREADY = preProcessStream_U0_xStreamIn_V_V_TREADY;

assign xStreamOut_V_V_TDATA = Block_proc124_U0_xStreamOut_V_V_TDATA;

assign xStreamOut_V_V_TVALID = Block_proc124_U0_xStreamOut_V_V_TVALID;

assign yStreamIn_V_V_TREADY = preProcessStream_U0_yStreamIn_V_V_TREADY;

assign yStreamOut_V_V_TDATA = Block_proc124_U0_yStreamOut_V_V_TDATA;

assign yStreamOut_V_V_TVALID = Block_proc124_U0_yStreamOut_V_V_TVALID;
