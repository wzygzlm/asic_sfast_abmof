...
wire    grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n;
reg    pktEventDataStream_V_V_blk_n;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_state3;
wire    grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n;
reg    stageCornerStream_V_V_blk_n;
wire    grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n;
reg    xStreamOut_V_V_TDATA_blk_n;
wire    grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n;
reg    yStreamOut_V_V_TDATA_blk_n;
wire    grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n;
reg    polStreamOut_V_V_TDATA_blk_n;
wire    grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n;
reg    tsStreamOut_V_V_TDATA_blk_n;
wire    grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n;
reg    isFinalCornerStream_V_V_TDATA_blk_n;
reg    glConfig_V_blk_n;
reg    glSFASTThrBak_blk_n;
reg    glStatus_inEventsNum_blk_n;
reg    grp_combineOutputStream_fu_123_ap_start;
wire    grp_combineOutputStream_fu_123_ap_done;
wire    grp_combineOutputStream_fu_123_ap_idle;
wire    grp_combineOutputStream_fu_123_ap_ready;
wire    grp_combineOutputStream_fu_123_packetEventDataStrea_read;
wire    grp_combineOutputStream_fu_123_stageCornerStream_V_s_read;
wire    grp_combineOutputStream_fu_123_xStreamOut_V_V_TREADY;
wire    grp_combineOutputStream_fu_123_yStreamOut_V_V_TREADY;
wire    grp_combineOutputStream_fu_123_polStreamOut_V_V_TREADY;
wire    grp_combineOutputStream_fu_123_tsStreamOut_V_V_TREADY;
wire    grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TREADY;
wire   [15:0] grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA;
wire    grp_combineOutputStream_fu_123_xStreamOut_V_V_TVALID;
wire   [15:0] grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA;
wire    grp_combineOutputStream_fu_123_yStreamOut_V_V_TVALID;
wire   [7:0] grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA;
wire    grp_combineOutputStream_fu_123_polStreamOut_V_V_TVALID;
wire   [63:0] grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA;
wire    grp_combineOutputStream_fu_123_tsStreamOut_V_V_TVALID;
wire   [15:0] grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA;
wire    grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TVALID;
wire   [63:0] grp_combineOutputStream_fu_123_glStatus_cornerEvent;
wire    grp_combineOutputStream_fu_123_glStatus_cornerEvent_ap_vld;
wire   [63:0] grp_combineOutputStream_fu_123_glStatus_outEventsNu;
wire    grp_combineOutputStream_fu_123_glStatus_outEventsNu_ap_vld;
wire   [7:0] grp_combineOutputStream_fu_123_glStatus_currentThre;
wire    grp_combineOutputStream_fu_123_glStatus_currentThre_ap_vld;
...
combineOutputStream grp_combineOutputStream_fu_123(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_combineOutputStream_fu_123_ap_start),
    .ap_done(grp_combineOutputStream_fu_123_ap_done),
    .ap_idle(grp_combineOutputStream_fu_123_ap_idle),
    .ap_ready(grp_combineOutputStream_fu_123_ap_ready),
    .packetEventDataStrea_dout(pktEventDataStream_V_V_dout),
    .packetEventDataStrea_empty_n(pktEventDataStream_V_V_empty_n),
    .packetEventDataStrea_read(grp_combineOutputStream_fu_123_packetEventDataStrea_read),
    .stageCornerStream_V_s_dout(stageCornerStream_V_V_dout),
    .stageCornerStream_V_s_empty_n(stageCornerStream_V_V_empty_n),
    .stageCornerStream_V_s_read(grp_combineOutputStream_fu_123_stageCornerStream_V_s_read),
    .xStreamOut_V_V_TREADY(grp_combineOutputStream_fu_123_xStreamOut_V_V_TREADY),
    .yStreamOut_V_V_TREADY(grp_combineOutputStream_fu_123_yStreamOut_V_V_TREADY),
    .polStreamOut_V_V_TREADY(grp_combineOutputStream_fu_123_polStreamOut_V_V_TREADY),
    .tsStreamOut_V_V_TREADY(grp_combineOutputStream_fu_123_tsStreamOut_V_V_TREADY),
    .custDataStreamOut_V_s_TREADY(grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TREADY),
    .xStreamOut_V_V_TDATA(grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA),
    .xStreamOut_V_V_TVALID(grp_combineOutputStream_fu_123_xStreamOut_V_V_TVALID),
    .yStreamOut_V_V_TDATA(grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA),
    .yStreamOut_V_V_TVALID(grp_combineOutputStream_fu_123_yStreamOut_V_V_TVALID),
    .polStreamOut_V_V_TDATA(grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA),
    .polStreamOut_V_V_TVALID(grp_combineOutputStream_fu_123_polStreamOut_V_V_TVALID),
    .tsStreamOut_V_V_TDATA(grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA),
    .tsStreamOut_V_V_TVALID(grp_combineOutputStream_fu_123_tsStreamOut_V_V_TVALID),
    .custDataStreamOut_V_s_TDATA(grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA),
    .custDataStreamOut_V_s_TVALID(grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TVALID),
    .p_read(glConfig_V_dout),
    .p_read1(glSFASTThrBak_dout),
    .glStatus_cornerEvent(grp_combineOutputStream_fu_123_glStatus_cornerEvent),
    .glStatus_cornerEvent_ap_vld(grp_combineOutputStream_fu_123_glStatus_cornerEvent_ap_vld),
    .glStatus_outEventsNu(grp_combineOutputStream_fu_123_glStatus_outEventsNu),
    .glStatus_outEventsNu_ap_vld(grp_combineOutputStream_fu_123_glStatus_outEventsNu_ap_vld),
    .glStatus_currentThre(grp_combineOutputStream_fu_123_glStatus_currentThre),
    .glStatus_currentThre_ap_vld(grp_combineOutputStream_fu_123_glStatus_currentThre_ap_vld),
    .packetEventDataStrea_blk_n(grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n),
    .stageCornerStream_V_s_blk_n(grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n),
    .xStreamOut_V_V_TDATA_blk_n(grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n),
    .yStreamOut_V_V_TDATA_blk_n(grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n),
    .polStreamOut_V_V_TDATA_blk_n(grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n),
    .tsStreamOut_V_V_TDATA_blk_n(grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n),
    .custDataStreamOut_V_s_TDATA_blk_n(grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n == 1'b0) | (glStatus_inEventsNum_empty_n == 1'b0) | (glSFASTThrBak_empty_n == 1'b0) | (glConfig_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if (((grp_combineOutputStream_fu_123_glStatus_cornerEvent_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        glStatus_cornerEvent <= grp_combineOutputStream_fu_123_glStatus_cornerEvent;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_combineOutputStream_fu_123_glStatus_currentThre_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        glStatus_currentThre <= grp_combineOutputStream_fu_123_glStatus_currentThre;
    end
end

always @ (posedge ap_clk) begin
    if (((grp_combineOutputStream_fu_123_glStatus_outEventsNu_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        glStatus_outEventsNu <= grp_combineOutputStream_fu_123_glStatus_outEventsNu;
    end
end
...
always @ (posedge ap_clk) begin
    if ((isFinalCornerStream_V_V_1_load_A == 1'b1)) begin
        isFinalCornerStream_V_V_1_payload_A <= grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((isFinalCornerStream_V_V_1_load_B == 1'b1)) begin
        isFinalCornerStream_V_V_1_payload_B <= grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((polStreamOut_V_V_1_load_A == 1'b1)) begin
        polStreamOut_V_V_1_payload_A <= grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((polStreamOut_V_V_1_load_B == 1'b1)) begin
        polStreamOut_V_V_1_payload_B <= grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((tsStreamOut_V_V_1_load_A == 1'b1)) begin
        tsStreamOut_V_V_1_payload_A <= grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((tsStreamOut_V_V_1_load_B == 1'b1)) begin
        tsStreamOut_V_V_1_payload_B <= grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((xStreamOut_V_V_1_load_A == 1'b1)) begin
        xStreamOut_V_V_1_payload_A <= grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((xStreamOut_V_V_1_load_B == 1'b1)) begin
        xStreamOut_V_V_1_payload_B <= grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((yStreamOut_V_V_1_load_A == 1'b1)) begin
        yStreamOut_V_V_1_payload_A <= grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((yStreamOut_V_V_1_load_B == 1'b1)) begin
        yStreamOut_V_V_1_payload_B <= grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA;
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (glStatus_inEventsNum_empty_n == 1'b0) | (glSFASTThrBak_empty_n == 1'b0) | (glConfig_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & ~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        grp_combineOutputStream_fu_123_ap_start = 1'b1;
    end else begin
        grp_combineOutputStream_fu_123_ap_start = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        isFinalCornerStream_V_V_TDATA_blk_n = grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        pktEventDataStream_V_V_blk_n = grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        pktEventDataStream_V_V_read = grp_combineOutputStream_fu_123_packetEventDataStrea_read;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
        stageCornerStream_V_V_blk_n = grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        stageCornerStream_V_V_read = grp_combineOutputStream_fu_123_stageCornerStream_V_s_read;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if ((~((grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n == 1'b0) | (glStatus_inEventsNum_empty_n == 1'b0) | (glSFASTThrBak_empty_n == 1'b0) | (glConfig_V_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state1_ignore_call13 = ((ap_start == 1'b0) | (glStatus_inEventsNum_empty_n == 1'b0) | (glSFASTThrBak_empty_n == 1'b0) | (glConfig_V_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state2 = ((grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n == 1'b0));
end

always @ (*) begin
    ap_block_state3 = ((grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_tsStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_polStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_yStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_xStreamOut_V_V_TDATA_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_stageCornerStream_V_s_blk_n == 1'b0) | (grp_combineOutputStream_fu_123_packetEventDataStrea_blk_n == 1'b0));
end
...
assign grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TREADY = isFinalCornerStream_V_V_1_state[1'd1];

assign grp_combineOutputStream_fu_123_polStreamOut_V_V_TREADY = polStreamOut_V_V_1_state[1'd1];

assign grp_combineOutputStream_fu_123_tsStreamOut_V_V_TREADY = tsStreamOut_V_V_1_state[1'd1];

assign grp_combineOutputStream_fu_123_xStreamOut_V_V_TREADY = xStreamOut_V_V_1_state[1'd1];

assign grp_combineOutputStream_fu_123_yStreamOut_V_V_TREADY = yStreamOut_V_V_1_state[1'd1];
...
assign isFinalCornerStream_V_V_1_vld_in = grp_combineOutputStream_fu_123_custDataStreamOut_V_s_TVALID;
...
assign polStreamOut_V_V_1_vld_in = grp_combineOutputStream_fu_123_polStreamOut_V_V_TVALID;
...
assign tsStreamOut_V_V_1_vld_in = grp_combineOutputStream_fu_123_tsStreamOut_V_V_TVALID;
...
assign xStreamOut_V_V_1_vld_in = grp_combineOutputStream_fu_123_xStreamOut_V_V_TVALID;
...
assign yStreamOut_V_V_1_vld_in = grp_combineOutputStream_fu_123_yStreamOut_V_V_TVALID;
